...
export const useAccountingValidation = <T extends z.ZodType>(schema: T) => {
  const validate = (data: z.input<T>): { success: boolean; errors?: Record<string, string>; data?: z.output<T> } => {
    try {
