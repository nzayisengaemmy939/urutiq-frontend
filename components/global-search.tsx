    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          data-search-input
          className="w-80 justify-start text-muted-foreground hover:text-foreground bg-transparent relative"
              ...
              <CommandGroup heading="Saved Filters">
                {savedFilters.map((filter, index) => (
                  <CommandItem
                    ...
                    className="flex items-center justify-between focus:bg-cyan-50 focus:text-cyan-900"
                  >
                    <div className="flex items-center">
                      <Filter className="mr-2 h-4 w-4 text-cyan-600" />
                      {filter.name}
                    </div>
                  </CommandItem>
                ))}
              ...
              <CommandGroup key={category} heading={category}>
                {items.map((item) => (
                  <CommandItem
                    ...
                    className="flex items-center justify-between focus:bg-cyan-50 focus:text-cyan-900 cursor-pointer"
                    role="option"
                  >
                    <div className="flex items-center flex-1 min-w-0">
                      <item.icon className="mr-2 h-4 w-4 text-cyan-600 flex-shrink-0" />
