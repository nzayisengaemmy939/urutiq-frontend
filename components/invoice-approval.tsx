          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Badge className={getStatusColor(approvalStatus.invoiceStatus)}>
                  {approvalStatus.invoiceStatus.toUpperCase()}
                </Badge>
              </div>
                  ...
                  {approvalStatus.approvals.map((approval) => (
                    <div key={approval.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium">Step {approval.stepNumber}</div>
              ...
              {approvalStatus.invoiceStatus === 'draft' && (
                <Button 
                  onClick={() => triggerApprovalMutation.mutate()}
                  disabled={triggerApprovalMutation.isPending}
                  className="w-full"
                >
                  {triggerApprovalMutation.isPending ? 'Triggering...' : 'Trigger Approval Workflow'}
                </Button>
              )}
            </div>
          </CardContent>
