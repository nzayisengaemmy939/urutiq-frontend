...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        "fixed left-0 top-0 bg-sidebar border-r border-sidebar-border transition-all duration-300 z-40 hidden lg:flex lg:flex-col",
        ...
        {navigationItems.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.href}
              className={cn(
                "flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:ring-2 focus:ring-cyan-500 focus:ring-offset-1",
                isActive
