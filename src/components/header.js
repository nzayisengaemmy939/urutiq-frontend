...
export function Header() {
    ...
    const { data: companies } = useQuery({
        ...
        queryFn: async () => {
            ...
            if (result?.companies && Array.isArray(result.companies)) {
                console.log('✅ Header - Returning result.companies:', result.companies.length, 'companies');
    ...
    // Temporarily disabled to debug header visibility
    // if (isLoading) {
