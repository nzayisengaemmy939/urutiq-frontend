export class ReceiptManager {
     ...
     */
    static async printReceipt(receiptElement, options = {}) {
        try {
     ...
     */
    static async emailReceipt(receiptData, options) {
        try {
     ...
     */
    static generateReceiptHTML(data) {
        return `
     ...
     */
    static async connectThermalPrinter() {
        try {
            if (!('usb' in navigator)) {
     ...
     */
    static async printToThermalPrinter(device, receiptData) {
        try {
